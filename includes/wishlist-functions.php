...
function wishlist_button(int $postId)
{
    ...
    echo '<button class="btn-wishlist wishlist-button-login-required' . esc_attr($class) . '" data-post-id="' . esc_attr($postId) . '"></button>';
}
...
function     display_wishlist_button(){
     wishlist_button(get_the_ID());
}
